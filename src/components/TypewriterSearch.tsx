...
const TypewriterSearch = ({ value, onChange, className, onFocus, onBlur }: TypewriterSearchProps) => {
  ...
  return (
    <Input
      ...
      className={cn(
        'h-20 md:h-24 text-3xl md:text-5xl font-thin text-black/20 font-[\'Inter\'] border-0 border-b border-black bg-transparent rounded-none px-5 md:ml-0 md:mr-0 outline-none focus-visible:ring-0 focus-visible:outline-none',
        className
      )}
    />
  );
