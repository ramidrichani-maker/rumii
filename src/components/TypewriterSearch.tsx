...
const TypewriterSearch = ({ value, onChange, className, onFocus, onBlur }: TypewriterSearchProps) => {
  ...
  return (
    <Input
      ...
      className={cn(
        'h-14 text-base md:text-lg border-0 border-b border-black bg-transparent rounded-none px-5 md:ml-0 md:mr-0 outline-none focus-visible:ring-0 focus-visible:outline-none',
        className
      )}
    />
  );
