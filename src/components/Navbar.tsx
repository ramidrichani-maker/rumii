            ...
            {/* Home icon — quick link to properties for sale */}
              ...
              {user ? <>
                {/* My rumi (icon only) */}
                    ...
                    >
                      <img src={profileIcon.url} alt="My rumi" className="h-[40px] w-[40px] md:h-[3.51rem] md:w-[3.51rem] translate-y-[0.2rem] md:translate-y-[0.5rem] object-contain" style={{ filter: 'brightness(0)' }} />
                    </button>
              </> : <>
                {/* Desktop Sign In */}
