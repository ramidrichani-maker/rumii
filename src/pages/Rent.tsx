...
const Rent = () => {
  ...
  const filterChips = buildFilterChips({
    ...
    priceRange, setPriceRange, priceDefault: [0, 10000],
  ...
  return (
    <div className="min-h-screen bg-transparent">
      ...
      {/* Sticky filter bar - direct child of full-height wrapper. When compare mode is
          active the bar is allowed to scroll away so it doesn't overlap the compare popup. */}
...
<div className="w-full bg-card border-t border-border shadow-2xl px-[4vw] py-8 flex items-center justify-between gap-4 flex-wrap min-h-[161px]">
                    ...
                    <div className="flex items-center gap-3 mr-[3vw]">
                      <button
                        ...
                        className="h-[3.8rem] px-[6.69rem] rounded-none border border-black bg-background text-sm font-medium hover:text-muted-foreground transition-colors"
                      >
                        Cancel
                      </button>
                      <button
...
/>
      ...
      <div className="px-[4vw]">
        <div className={`flex ${showMap ? 'flex-col-reverse md:flex-row' : 'flex-col'} gap-6`}>
          ...
          >
            {isLoading ? (
              <div className={`mb-8 grid grid-cols-2 ${showMap ? 'md:grid-cols-1' : 'md:grid-cols-3'} gap-[0.5vw] md:gap-[0.5vw]`}>
              ...
              <div className="mb-8">
                ...
                <div className={`grid grid-cols-2 ${showMap ? 'md:grid-cols-1' : 'md:grid-cols-3'} gap-[0.5vw] md:gap-[0.5vw]`}>
